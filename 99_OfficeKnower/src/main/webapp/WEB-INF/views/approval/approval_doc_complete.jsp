...
<div class="tab-content" id="myTabContent">
  <div class="tab-pane fade show active" id="approval" role="tabpanel" aria-labelledby="approval-tab">
	    ...
	    <tr class="trtr" onclick='location.href="${pageContext.request.contextPath}/office/approvalView?approval_no=${v.approval_no }&navkind=완료"'>
	    	<td>${v.approval_no }</td>
	    	<td>${v.title }</td>
	    	<td>${v.writer }</td>
	    	<td>${v.writeDate }</td>
  ...
  <div class="tab-pane fade" id="breakRequest" role="tabpanel" aria-labelledby="breakRequest-tab">
	    ...
	    <tr class="trtr" onclick='location.href="${pageContext.request.contextPath}/office/approvalBreakRequestView?break_request_no=${v.break_request_no }&navkind=완료"'>
