...
<jsp:include page="/WEB-INF/views/common/nav.jsp">
	<jsp:param value="전자결재" name="pageTitle" />
	<jsp:param value="예정" name="selectMenu" />
</jsp:include>
...
<h6 style="font-weight:bold">예정</h6>

<hr />
<p style="color:rgb(200,200,200)">※ 예정 목록</p>
...
<div class="tab-content" id="myTabContent">
  <div class="tab-pane fade show active" id="approval" role="tabpanel" aria-labelledby="approval-tab">
	    ...
	    <c:forEach var="v" items="${approvalExpectedList }">
	    <c:set var="navkind" value="예정"/>
	    ...
	    <tr class="trtr" onclick='location.href="${pageContext.request.contextPath}/office/approvalBreakRequestView?break_request_no=${v.BREAK_REQUEST_NO }&navkind=${navkind}"' >
	    	...
	    	<td>
	    		<c:if test="${v.RENAMED_FILE_NAME != 'no'}"> 
	    			<img src="${pageContext.request.contextPath }/images/common/board_file_image.PNG" alt="첨부파일" />
	    		</c:if>		
	    	</td>
	    	<td>${v.STARTDATE }</td>
	    	<td>${v.ENDDATE }</td>
