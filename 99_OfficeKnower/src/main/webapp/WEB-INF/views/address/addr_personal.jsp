...
<head>
	...
	<script src="../resources/static/ui/js/main.js"></script>
		...
		<script src="../resources/static/scripts/addr/addrNewCommon.js" type="text/javascript"></script>
	<script src="../resources/static/scripts/AngularJS/file-upload/ng-file-upload-shim.min.js" type="text/javascript"></script>
	<script src="../resources/static/scripts/AngularJS/angular_1.2.28.js" type="text/javascript"></script>
	<script src="../resources/static/scripts/AngularJS/file-upload/ng-file-upload.js" type="text/javascript"></script>
	<script src="../resources/static/scripts/addr/angularjsFactory.js" type="text/javascript"></script>
	<script src="../resources/static/scripts/addr/angularjsAddressCtrl.js" type="text/javascript"></script>
	<script src="../resources/static/scripts/AngularJS/hiworks/ngPage/pagination_factory.js" type="text/javascript"></script>
