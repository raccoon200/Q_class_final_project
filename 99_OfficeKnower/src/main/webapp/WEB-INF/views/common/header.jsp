...
<!-- 아이콘 -->
<link rel="stylesheet"
	href="${pageContext.request.contextPath }/resources/css/Font-Face/style.css" />
<!-- 구글 폰트 -->
<link
	href="https://fonts.googleapis.com/css?family=Nanum+Gothic|Sunflower:300"
	rel="stylesheet">
<link rel="stylesheet"
	...
	$(function() {
		...
		$("#address_btn")
				.on(
						"click",
						function() {
							location.href = "${pageContext.request.contextPath}/address/addressView.do";
						});
		/* 예약 */
		$("#reservation_btn")
				.on(
		...
		<header class="jumbotron" id="header">
			<h1 class="logo_container">
				<a href="${pageContext.request.contextPath }/office/office_main.do">
					<img
					src="${pageContext.request.contextPath }/resources/images/common/logo.png"
					alt="로고" style="width: 60px; height: 30px;" />
				</a>
			</h1>
			<div id="gnb">
				${param.pageTitle } &nbsp; <span aria-hidden="true"
					class="icon-arrow-down" style="font-size: 15px; color: lightgray;"></span>
			</div>
			<!-- hover시 메뉴 컨테이너 -->
			<div id="menu_container" class="header_container"
				style="display: none;">
				<img
					src="${pageContext.request.contextPath }/resources/images/common/sp_icon.jpg"
					alt="" class="sp_icon" id="sp_icon_menu" />

				<div class="menu_btn" id="insa_btn">
					<img
						src="${pageContext.request.contextPath }/resources/images/common/insa_small.png"
						alt="인사" /><br />
					<p>인사관리</p>
				</div>
				<div class="menu_btn" id="sch_btn">
					<img
						src="${pageContext.request.contextPath }/resources/images/common/sch_small.png"
						alt="일정" /><br />
					<p>일정관리</p>
				</div>
				<div class="menu_btn" id="board_btn">
					<img
						src="${pageContext.request.contextPath }/resources/images/common/board_small.png"
						alt="게시판" /><br />
					<p>게시판</p>
				</div>
				<div class="menu_btn" id="check_btn">
					<img
						src="${pageContext.request.contextPath }/resources/images/common/check_small.png"
						alt="결재" /><br />
					<p>전자결재</p>
				</div>
				<div class="menu_btn" id="address_btn">
					<img
						src="${pageContext.request.contextPath }/resources/images/common/address_small.png"
						alt="주소록" /><br />
					<p>주소록</p>
				</div>
				<div class="menu_btn" id="reservation_btn">
					<img
						src="${pageContext.request.contextPath }/resources/images/common/reservation_small.png"
						alt="예약" /><br />
					<p>예약</p>
				</div>
			</div>
			...
			<div id="userBox">
				...
				<div style="display: inline-block; margin: 12px 0 0 5px;">
					...
					<span aria-hidden="true" class="icon-arrow-down"
						style="font-size: 13px; color: lightgray;"></span>
				</div>
			</div>
			<!-- hover시 user 상세정보 -->
			<div id="user-detail" class="header_container">
				<img
					src="${pageContext.request.contextPath }/resources/images/common/sp_icon.jpg"
					alt="" class="sp_icon" id="sp_icon_detail" />
				<div class="pic">
					<img
						src="${pageContext.request.contextPath }/resources/upload/member/${memberLoggedIn.photo}"
				...
				<div class="text">
					...
					<p>
						<!-- 설정 URL등록해야됨 -->
						<a
							href="${pageContext.request.contextPath }/member/memberOneSelect.do?userId=${memberLoggedIn.userId}">설정</a>
					</p>
					<!-- 로그아웃 -->
			...
			<div id="notice-container" class="header_container">
				<img
					src="${pageContext.request.contextPath }/resources/images/common/sp_icon.jpg"
					alt="" class="sp_icon" id="sp_icon_notice" />
			</div>
		</header>